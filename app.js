...
console.log("Hello human, u will be playing against the computer for a game of rock-papers-scissors, first to 3 is the winner, just write your choice when instructed to, goodluck!");
